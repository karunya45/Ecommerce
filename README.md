...
class Product {
    ...
    void display() {
        System.out.println(Colors.CYAN + id + ". " + Colors.RESET + Colors.BOLD + name + 
                           Colors.RESET + " | " + Colors.PURPLE + brand + Colors.RESET + " | " + Colors.GREEN + "₹" + price + Colors.RESET);
    }
}
...
class Cart {
    ...
    void remove(int index) {
        for (int i = index; i < count - 1; i++)
            items[i] = items[i + 1];
        count--;
        System.out.println(Colors.RED + "✔ Item removed" + Colors.RESET);
    }
    ...
    void showCart() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            System.out.println((i + 1) + ") " + items[i].product.name + " x" + items[i].quantity + " - " + Colors.GREEN + "₹" + subTotal + Colors.RESET);
            total += subTotal;
        }
        System.out.println(Colors.BOLD + "Total Items: " + count + Colors.RESET);
        System.out.println(Colors.GREEN + "Grand Total: ₹" + total + Colors.RESET);
    }
}
...
public class Comm {
    ...
    public static void main(String[] args) {
        loadProducts();
        System.out.println(Colors.YELLOW + Colors.BOLD + "🛒 WELCOME TO JAVA MART 🛒" + Colors.RESET);
    ...
    static void payment(Customer c) {
        ...
        System.out.println(Colors.GREEN + "\nPayment Successful ✅" + Colors.RESET);
